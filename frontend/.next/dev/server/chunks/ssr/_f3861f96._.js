...
"[project]/app/(dashboard)/dashboard/my-polls/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PollMiniCard({ poll, onDelete }) {
    ...
    const handleDelete = async ()=>{
        ...
        setIsDeleting(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pollsApi"].deletePoll(poll.id);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Sondage supprimé");
            onDelete();
        } catch (error) {
...
function MyPollsPage() {
    ...
    const loadPolls = async ()=>{
        setIsLoading(true);
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pollsApi"].getMyPolls();
            setPolls(data);
        } catch (error) {
...
//# sourceMappingURL=_f3861f96._.js.map